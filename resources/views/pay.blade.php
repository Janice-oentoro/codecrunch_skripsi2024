            ...
            <div class="col-7" >
                <div class="d-flex flex-row">
                    <div class="ms-4 my-3 d-flex flex-row justify-content-between align-items-end w-100" >
                        <div>
                            @if($cons->avatar != null) 
                            <img src="{{ asset($avatar) }}" width="350" height="200px" style="object-fit: cover;">
                            @else
                            <img src="{{ asset('/storage/images/def-icon.png') }}" width="350" height="200px" style="object-fit: cover;">
                            @endif
